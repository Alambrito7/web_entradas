...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-md-8">
            <h2><i class="bi bi-plus-circle"></i> Crear Nuevo Rol</h2>
            <p class="text-muted">Define un nuevo rol con permisos personalizados</p>
        </div>
                                ...
                                <div class="permission-item">
                                    <div class="form-check">
                                        <input class="form-check-input" 
                                               ...
                                               data-module="{{ $moduloKey }}"
                                               {{ (is_array(old('permisos.'.$moduloKey)) && in_array($accionKey, old('permisos.'.$moduloKey))) ? 'checked' : '' }}>
...
<script>
    ...
    document.querySelectorAll('.select-all-btn').forEach(button => {
        button.addEventListener('click', function() {
            ...
            if (allChecked) {
                this.innerHTML = '<i class="bi bi-check-all"></i> Seleccionar Todo';
            } else {
                this.innerHTML = '<i class="bi bi-x-circle"></i> Deseleccionar Todo';
            }
        });
    });
