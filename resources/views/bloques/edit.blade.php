...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-md-8">
            <h2><i class="bi bi-pencil"></i> Editar Bloque: {{ $bloque->nombre }}</h2>
            <p class="text-muted">Modifica la información del bloque</p>
        </div>
        <div class="col-md-4 text-end">
            <a href="{{ route('bloques.show', $bloque) }}" class="btn btn-outline-secondary">
    ...
    <form action="{{ route('bloques.update', $bloque) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select @error('fraternidad_id') is-invalid @enderror" 
                        ...
                        @foreach($fraternidades as $fraternidad)
                            <option value="{{ $fraternidad->id }}" {{ old('fraternidad_id', $bloque->fraternidad_id) == $fraternidad->id ? 'selected' : '' }}>
                                {{ $fraternidad->nombre }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-6">
                    ...
                    <input type="date" 
                           ...
                           value="{{ old('fecha_fundacion', $bloque->fecha_fundacion?->format('Y-m-d')) }}">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select @error('estado') is-invalid @enderror" 
                        ...
                        @foreach($estados as $key => $value)
                            <option value="{{ $key }}" {{ old('estado', $bloque->estado) == $key ? 'selected' : '' }}>
                                {{ $value }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-12">
                    ...
                    <textarea class="form-control @error('historia') is-invalid @enderror" 
                              ...
                              name="historia" 
                              rows="4"
                              placeholder="Escribe la historia del bloque...">{{ old('historia', $bloque->historia) }}</textarea>
                    @error('historia')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
        ...
        <div class="form-section">
            ...
            <div id="responsables-container">
                @foreach($bloque->responsables as $index => $responsable)
                    <div class="responsable-item" id="responsable-{{ $index }}">
                        <button type="button" class="btn btn-sm btn-danger remove-btn" onclick="removeResponsable({{ $index }})">
                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" 
                                       class="form-control" 
                                       name="responsables[{{ $index }}][nombre]" 
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" 
                                       class="form-control" 
                                       name="responsables[{{ $index }}][telefono]" 
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="number" 
                           ...
                           value="{{ old('integrantes_aproximados', $bloque->integrantes_aproximados) }}"
                           min="0">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="url" 
                           ...
                           id="facebook" 
                           name="facebook" 
                           value="{{ old('facebook', $bloque->facebook) }}"
                ...
                <div class="col-md-6">
                    ...
                    <input type="url" 
                           ...
                           id="youtube" 
                           name="youtube" 
                           value="{{ old('youtube', $bloque->youtube) }}"
            ...
            <div class="row g-3">
                @if($bloque->foto_principal)
                    <div class="col-md-12">
                        ...
                        <div>
                            <img src="{{ Storage::url($bloque->foto_principal) }}" alt="{{ $bloque->nombre }}" class="current-image">
                        </div>
                    </div>
                @endif
                ...
                <div class="col-md-12">
                    <label for="foto_principal" class="form-label">
                        {{ $bloque->foto_principal ? 'Cambiar Foto' : 'Seleccionar Foto' }}
                    </label>
                    <input type="file" 
        ...
        <div class="form-section">
            <div class="d-flex justify-content-between">
                <a href="{{ route('bloques.show', $bloque) }}" class="btn btn-secondary">
...
@section('scripts')
<script>
    let responsableIndex = {{ $bloque->responsables->count() }};
